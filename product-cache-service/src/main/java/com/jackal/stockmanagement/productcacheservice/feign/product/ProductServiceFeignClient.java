...
import com.jackal.stockmanagement.productcacheservice.enuıms.Language;
...
public interface ProductServiceFeignClient {
    ...
    InternalApiResponse<ProductResponse> getProduct(@PathVariable("language") Language language, @PathVariable("productId") String productId);
}
